...
```
Gefundene Dateien:
  1. spezifikation.pdf  → quelldokumente/api-spezifikation/  (neuer Ordner)
  2. screenshot.png     → quelldokumente/api-spezifikation/  (selbe Quelle wie 1)
  3. links.txt (2 URLs):
       https://...     → quelldokumente/externe-docs/  (neuer Ordner, scrape als .md)
...
| **Link** | Seitentitel, vollständiger Fließtext, Quell-URL und Abrufdatum. |
